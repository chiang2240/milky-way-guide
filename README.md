# 🌌 Vivo X300 Ultra 銀河拍攝完整教學手冊

使用 Vivo X300 Ultra 手機專業模式拍攝銀河的完整指南，從參數設定到現場構圖，從規劃時機到選擇地點，一站搞定。
...
1. 先讀 [規劃指南](vivo_x300_ultra_milky_way_planning.md) — 確認什麼時候適合出門
2. 再讀 [地點指南](vivo_x300_ultra_milky_way_locations.md) — 決定去哪裡
3. 出發前讀 [參數設定手冊](vivo_x300_ultra_milky_way_guide.md) — 知道到現場怎麼設定
4. 現場參考 [構圖技巧](vivo_x300_ultra_milky_way_composition.md) — 拍出好照片
